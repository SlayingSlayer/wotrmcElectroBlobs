...
public class Wizardry {
	...
	private static int frostPotionID = 116;
	/** The id of the fireskin potion effect. */
	private static int transiencePotionID = 117;
	/** The id of the fireskin potion effect. */
	private static int fireskinPotionID = 118;
	/** The id of the ice shroud potion effect. */
	private static int iceShroudPotionID = 119;
	/** The id of the static aura potion effect. */
	private static int staticAuraPotionID = 121;
	/** The id of the decay potion effect. */
	private static int decayPotionID = 122;
	/** The id of the sixth sense potion effect. */
	private static int sixthSensePotionID = 123;
	/** The id of the arcane jammer potion effect. */
	private static int arcaneJammerPotionID = 124;
	/** The id of the mind trick potion effect. */
	private static int mindTrickPotionID = 108;
	/** The id of the mind control potion effect. */
	private static int mindControlPotionID = 109;
	/** The id of the font of mana potion effect. */
	private static int fontOfManaPotionID = 125;
	/** The id of the fear potion effect. */
	private static int fearPotionID = 111;
	/** The id of the magic sword enchantment. */
	private static int magicSwordEnchantmentID = 112;
	/** The id of the magic bow enchantment. */
	private static int magicBowEnchantmentID = 113;
	/** The id of the flaming weapon enchantment. */
	private static int flamingWeaponEnchantmentID = 114;
	/** The id of the flaming weapon enchantment. */
	private static int freezingWeaponEnchantmentID = 115;
...
//		}
	...
	public final static Item wizardHatFireIce = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.FIRE).setTextureName("wizardry:wizard_hat_ice");
	public final static Item wizardRobeFireIce = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.FIRE).setTextureName("wizardry:wizard_robe_ice");
	public final static Item wizardLeggingsFireIce = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.FIRE).setTextureName("wizardry:wizard_leggings_ice");
	public final static Item wizardBootsFireIce = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.FIRE).setTextureName("wizardry:wizard_boots_ice");

	public final static Item wizardHatFireLightning = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.FIRE).setTextureName("wizardry:wizard_hat_lightning");
	public final static Item wizardRobeFireLightning = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.FIRE).setTextureName("wizardry:wizard_robe_lightning");
	public final static Item wizardLeggingsFireLightning = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.FIRE).setTextureName("wizardry:wizard_leggings_lightning");
	public final static Item wizardBootsFireLightning = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.FIRE).setTextureName("wizardry:wizard_boots_lightning");
	
	public final static Item wizardHatFireNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.FIRE).setTextureName("wizardry:wizard_hat_necromancy");
	public final static Item wizardRobeFireNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.FIRE).setTextureName("wizardry:wizard_robe_necromancy");
	public final static Item wizardLeggingsFireNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.FIRE).setTextureName("wizardry:wizard_leggings_necromancy");
	public final static Item wizardBootsFireNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.FIRE).setTextureName("wizardry:wizard_boots_necromancy");
	
	public final static Item wizardHatFireEarth = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.FIRE).setTextureName("wizardry:wizard_hat_earth");
	public final static Item wizardRobeFireEarth = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.FIRE).setTextureName("wizardry:wizard_robe_earth");
	public final static Item wizardLeggingsFireEarth = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.FIRE).setTextureName("wizardry:wizard_leggings_earth");
	public final static Item wizardBootsFireEarth = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.FIRE).setTextureName("wizardry:wizard_boots_earth");
	
	public final static Item wizardHatFireSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.FIRE).setTextureName("wizardry:wizard_hat_sorcery");
	public final static Item wizardRobeFireSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.FIRE).setTextureName("wizardry:wizard_robe_sorcery");
	public final static Item wizardLeggingsFireSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.FIRE).setTextureName("wizardry:wizard_leggings_sorcery");
	public final static Item wizardBootsFireSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.FIRE).setTextureName("wizardry:wizard_boots_sorcery");
	
	public final static Item wizardHatFireHealing = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.FIRE).setTextureName("wizardry:wizard_hat_healing");
	public final static Item wizardRobeFireHealing = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.FIRE).setTextureName("wizardry:wizard_robe_healing");
	public final static Item wizardLeggingsFireHealing = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.FIRE).setTextureName("wizardry:wizard_leggings_healing");
	public final static Item wizardBootsFireHealing = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.FIRE).setTextureName("wizardry:wizard_boots_healing");
	
	public final static Item wizardHatIceFire = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.ICE).setTextureName("wizardry:wizard_hat_fire");
	public final static Item wizardRobeIceFire = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.ICE).setTextureName("wizardry:wizard_robe_fire");
	public final static Item wizardLeggingsIceFire = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.ICE).setTextureName("wizardry:wizard_leggings_fire");
	public final static Item wizardBootsIceFire = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.ICE).setTextureName("wizardry:wizard_boots_fire");

	public final static Item wizardHatIceLightning = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.ICE).setTextureName("wizardry:wizard_hat_lightning");
	public final static Item wizardRobeIceLightning = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.ICE).setTextureName("wizardry:wizard_robe_lightning");
	public final static Item wizardLeggingsIceLightning = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.ICE).setTextureName("wizardry:wizard_leggings_lightning");
	public final static Item wizardBootsIceLightning = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.ICE).setTextureName("wizardry:wizard_boots_lightning");
	
	public final static Item wizardHatIceNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.ICE).setTextureName("wizardry:wizard_hat_necromancy");
	public final static Item wizardRobeIceNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.ICE).setTextureName("wizardry:wizard_robe_necromancy");
	public final static Item wizardLeggingsIceNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.ICE).setTextureName("wizardry:wizard_leggings_necromancy");
	public final static Item wizardBootsIceNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.ICE).setTextureName("wizardry:wizard_boots_necromancy");
	
	public final static Item wizardHatIceEarth = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.ICE).setTextureName("wizardry:wizard_hat_earth");
	public final static Item wizardRobeIceEarth = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.ICE).setTextureName("wizardry:wizard_robe_earth");
	public final static Item wizardLeggingsIceEarth = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.ICE).setTextureName("wizardry:wizard_leggings_earth");
	public final static Item wizardBootsIceEarth = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.ICE).setTextureName("wizardry:wizard_boots_earth");
	
	public final static Item wizardHatIceSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.ICE).setTextureName("wizardry:wizard_hat_sorcery");
	public final static Item wizardRobeIceSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.ICE).setTextureName("wizardry:wizard_robe_sorcery");
	public final static Item wizardLeggingsIceSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.ICE).setTextureName("wizardry:wizard_leggings_sorcery");
	public final static Item wizardBootsIceSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.ICE).setTextureName("wizardry:wizard_boots_sorcery");
	
	public final static Item wizardHatIceHealing = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.ICE).setTextureName("wizardry:wizard_hat_healing");
	public final static Item wizardRobeIceHealing = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.ICE).setTextureName("wizardry:wizard_robe_healing");
	public final static Item wizardLeggingsIceHealing = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.ICE).setTextureName("wizardry:wizard_leggings_healing");
	public final static Item wizardBootsIceHealing = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.ICE).setTextureName("wizardry:wizard_boots_healing");

	public final static Item wizardHatLightningIce = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_hat_ice");
	public final static Item wizardRobeLightningIce = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_robe_ice");
	public final static Item wizardLeggingsLightningIce = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_leggings_ice");
	public final static Item wizardBootsLightningIce = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_boots_ice");

	public final static Item wizardHatLightningFire = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_hat_fire");
	public final static Item wizardRobeLightningFire = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_robe_fire");
	public final static Item wizardLeggingsLightningFire = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_leggings_fire");
	public final static Item wizardBootsLightningFire = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_boots_fire");
	
	public final static Item wizardHatLightningNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_hat_necromancy");
	public final static Item wizardRobeLightningNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_robe_necromancy");
	public final static Item wizardLeggingsLightningNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_leggings_necromancy");
	public final static Item wizardBootsLightningNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_boots_necromancy");
	
	public final static Item wizardHatLightningEarth = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_hat_earth");
	public final static Item wizardRobeLightningEarth = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_robe_earth");
	public final static Item wizardLeggingsLightningEarth = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_leggings_earth");
	public final static Item wizardBootsLightningEarth = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_boots_earth");
	
	public final static Item wizardHatLightningSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_hat_sorcery");
	public final static Item wizardRobeLightningSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_robe_sorcery");
	public final static Item wizardLeggingsLightningSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_leggings_sorcery");
	public final static Item wizardBootsLightningSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_boots_sorcery");
	
	public final static Item wizardHatLightningHealing = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_hat_healing");
	public final static Item wizardRobeLightningHealing = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_robe_healing");
	public final static Item wizardLeggingsLightningHealing = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_leggings_healing");
	public final static Item wizardBootsLightningHealing = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.LIGHTNING).setTextureName("wizardry:wizard_boots_healing");
	
	public final static Item wizardHatNecromancyIce = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_hat_ice");
	public final static Item wizardRobeNecromancyIce = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_robe_ice");
	public final static Item wizardLeggingsNecromancyIce = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_leggings_ice");
	public final static Item wizardBootsNecromancyIce = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_boots_ice");

	public final static Item wizardHatNecromancyLightning = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_hat_lightning");
	public final static Item wizardRobeNecromancyLightning = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_robe_lightning");
	public final static Item wizardLeggingsNecromancyLightning = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_leggings_lightning");
	public final static Item wizardBootsNecromancyLightning = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_boots_lightning");
	
	public final static Item wizardHatNecromancyFire = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_hat_fire");
	public final static Item wizardRobeNecromancyFire = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_robe_fire");
	public final static Item wizardLeggingsNecromancyFire = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_leggings_fire");
	public final static Item wizardBootsNecromancyFire = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_boots_fire");
	
	public final static Item wizardHatNecromancyEarth = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_hat_earth");
	public final static Item wizardRobeNecromancyEarth = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_robe_earth");
	public final static Item wizardLeggingsNecromancyEarth = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_leggings_earth");
	public final static Item wizardBootsNecromancyEarth = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_boots_earth");
	
	public final static Item wizardHatNecromancySorcery = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_hat_sorcery");
	public final static Item wizardRobeNecromancySorcery = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_robe_sorcery");
	public final static Item wizardLeggingsNecromancySorcery = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_leggings_sorcery");
	public final static Item wizardBootsNecromancySorcery = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_boots_sorcery");
	
	public final static Item wizardHatNecromancyHealing = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_hat_healing");
	public final static Item wizardRobeNecromancyHealing = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_robe_healing");
	public final static Item wizardLeggingsNecromancyHealing = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_leggings_healing");
	public final static Item wizardBootsNecromancyHealing = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.NECROMANCY).setTextureName("wizardry:wizard_boots_healing");
	
	public final static Item wizardHatEarthIce = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.EARTH).setTextureName("wizardry:wizard_hat_ice");
	public final static Item wizardRobeEarthIce = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.EARTH).setTextureName("wizardry:wizard_robe_ice");
	public final static Item wizardLeggingsEarthIce = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.EARTH).setTextureName("wizardry:wizard_leggings_ice");
	public final static Item wizardBootsEarthIce = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.EARTH).setTextureName("wizardry:wizard_boots_ice");

	public final static Item wizardHatEarthLightning = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.EARTH).setTextureName("wizardry:wizard_hat_lightning");
	public final static Item wizardRobeEarthLightning = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.EARTH).setTextureName("wizardry:wizard_robe_lightning");
	public final static Item wizardLeggingsEarthLightning = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.EARTH).setTextureName("wizardry:wizard_leggings_lightning");
	public final static Item wizardBootsEarthLightning = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.EARTH).setTextureName("wizardry:wizard_boots_lightning");
	
	public final static Item wizardHatEarthNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.EARTH).setTextureName("wizardry:wizard_hat_necromancy");
	public final static Item wizardRobeEarthNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.EARTH).setTextureName("wizardry:wizard_robe_necromancy");
	public final static Item wizardLeggingsEarthNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.EARTH).setTextureName("wizardry:wizard_leggings_necromancy");
	public final static Item wizardBootsEarthNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.EARTH).setTextureName("wizardry:wizard_boots_necromancy");
	
	public final static Item wizardHatEarthFire = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.EARTH).setTextureName("wizardry:wizard_hat_fire");
	public final static Item wizardRobeEarthFire = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.EARTH).setTextureName("wizardry:wizard_robe_fire");
	public final static Item wizardLeggingsEarthFire = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.EARTH).setTextureName("wizardry:wizard_leggings_fire");
	public final static Item wizardBootsEarthFire = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.EARTH).setTextureName("wizardry:wizard_boots_fire");
	
	public final static Item wizardHatEarthSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.EARTH).setTextureName("wizardry:wizard_hat_sorcery");
	public final static Item wizardRobeEarthSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.EARTH).setTextureName("wizardry:wizard_robe_sorcery");
	public final static Item wizardLeggingsEarthSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.EARTH).setTextureName("wizardry:wizard_leggings_sorcery");
	public final static Item wizardBootsEarthSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.EARTH).setTextureName("wizardry:wizard_boots_sorcery");
	
	public final static Item wizardHatEarthHealing = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.EARTH).setTextureName("wizardry:wizard_hat_healing");
	public final static Item wizardRobeEarthHealing = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.EARTH).setTextureName("wizardry:wizard_robe_healing");
	public final static Item wizardLeggingsEarthHealing = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.EARTH).setTextureName("wizardry:wizard_leggings_healing");
	public final static Item wizardBootsEarthHealing = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.EARTH).setTextureName("wizardry:wizard_boots_healing");
	
	public final static Item wizardHatSorceryIce = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.SORCERY).setTextureName("wizardry:wizard_hat_ice");
	public final static Item wizardRobeSorceryIce = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.SORCERY).setTextureName("wizardry:wizard_robe_ice");
	public final static Item wizardLeggingsSorceryIce = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.SORCERY).setTextureName("wizardry:wizard_leggings_ice");
	public final static Item wizardBootsSorceryIce = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.SORCERY).setTextureName("wizardry:wizard_boots_ice");

	public final static Item wizardHatSorceryLightning = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.SORCERY).setTextureName("wizardry:wizard_hat_lightning");
	public final static Item wizardRobeSorceryLightning = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.SORCERY).setTextureName("wizardry:wizard_robe_lightning");
	public final static Item wizardLeggingsSorceryLightning = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.SORCERY).setTextureName("wizardry:wizard_leggings_lightning");
	public final static Item wizardBootsSorceryLightning = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.SORCERY).setTextureName("wizardry:wizard_boots_lightning");
	
	public final static Item wizardHatSorceryNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.SORCERY).setTextureName("wizardry:wizard_hat_necromancy");
	public final static Item wizardRobeSorceryNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.SORCERY).setTextureName("wizardry:wizard_robe_necromancy");
	public final static Item wizardLeggingsSorceryNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.SORCERY).setTextureName("wizardry:wizard_leggings_necromancy");
	public final static Item wizardBootsSorceryNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.SORCERY).setTextureName("wizardry:wizard_boots_necromancy");
	
	public final static Item wizardHatSorceryEarth = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.SORCERY).setTextureName("wizardry:wizard_hat_earth");
	public final static Item wizardRobeSorceryEarth = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.SORCERY).setTextureName("wizardry:wizard_robe_earth");
	public final static Item wizardLeggingsSorceryEarth = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.SORCERY).setTextureName("wizardry:wizard_leggings_earth");
	public final static Item wizardBootsSorceryEarth = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.SORCERY).setTextureName("wizardry:wizard_boots_earth");
	
	public final static Item wizardHatSorceryFire = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.SORCERY).setTextureName("wizardry:wizard_hat_fire");
	public final static Item wizardRobeSorceryFire = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.SORCERY).setTextureName("wizardry:wizard_robe_fire");
	public final static Item wizardLeggingsSorceryFire = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.SORCERY).setTextureName("wizardry:wizard_leggings_fire");
	public final static Item wizardBootsSorceryFire = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.SORCERY).setTextureName("wizardry:wizard_boots_fire");
	
	public final static Item wizardHatSorceryHealing = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.SORCERY).setTextureName("wizardry:wizard_hat_healing");
	public final static Item wizardRobeSorceryHealing = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.SORCERY).setTextureName("wizardry:wizard_robe_healing");
	public final static Item wizardLeggingsSorceryHealing = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.SORCERY).setTextureName("wizardry:wizard_leggings_healing");
	public final static Item wizardBootsSorceryHealing = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.SORCERY).setTextureName("wizardry:wizard_boots_healing");
	
	public final static Item wizardHatHealingIce = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.HEALING).setTextureName("wizardry:wizard_hat_ice");
	public final static Item wizardRobeHealingIce = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.HEALING).setTextureName("wizardry:wizard_robe_ice");
	public final static Item wizardLeggingsHealingIce = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.HEALING).setTextureName("wizardry:wizard_leggings_ice");
	public final static Item wizardBootsHealingIce = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.HEALING).setTextureName("wizardry:wizard_boots_ice");

	public final static Item wizardHatHealingLightning = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.HEALING).setTextureName("wizardry:wizard_hat_lightning");
	public final static Item wizardRobeHealingLightning = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.HEALING).setTextureName("wizardry:wizard_robe_lightning");
	public final static Item wizardLeggingsHealingLightning = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.HEALING).setTextureName("wizardry:wizard_leggings_lightning");
	public final static Item wizardBootsHealingLightning = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.HEALING).setTextureName("wizardry:wizard_boots_lightning");
	
	public final static Item wizardHatHealingNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.HEALING).setTextureName("wizardry:wizard_hat_necromancy");
	public final static Item wizardRobeHealingNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.HEALING).setTextureName("wizardry:wizard_robe_necromancy");
	public final static Item wizardLeggingsHealingNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.HEALING).setTextureName("wizardry:wizard_leggings_necromancy");
	public final static Item wizardBootsHealingNecromancy = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.HEALING).setTextureName("wizardry:wizard_boots_necromancy");
	
	public final static Item wizardHatHealingEarth = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.HEALING).setTextureName("wizardry:wizard_hat_earth");
	public final static Item wizardRobeHealingEarth = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.HEALING).setTextureName("wizardry:wizard_robe_earth");
	public final static Item wizardLeggingsHealingEarth = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.HEALING).setTextureName("wizardry:wizard_leggings_earth");
	public final static Item wizardBootsHealingEarth = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.HEALING).setTextureName("wizardry:wizard_boots_earth");
	
	public final static Item wizardHatHealingSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.HEALING).setTextureName("wizardry:wizard_hat_sorcery");
	public final static Item wizardRobeHealingSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.HEALING).setTextureName("wizardry:wizard_robe_sorcery");
	public final static Item wizardLeggingsHealingSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.HEALING).setTextureName("wizardry:wizard_leggings_sorcery");
	public final static Item wizardBootsHealingSorcery = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.HEALING).setTextureName("wizardry:wizard_boots_sorcery");
	
	public final static Item wizardHatHealingFire = new ItemWizardArmour(Wizardry.SILK, 1, 0, EnumElement.HEALING).setTextureName("wizardry:wizard_hat_fire");
	public final static Item wizardRobeHealingFire = new ItemWizardArmour(Wizardry.SILK, 1, 1, EnumElement.HEALING).setTextureName("wizardry:wizard_robe_fire");
	public final static Item wizardLeggingsHealingFire = new ItemWizardArmour(Wizardry.SILK, 1, 2, EnumElement.HEALING).setTextureName("wizardry:wizard_leggings_fire");
	public final static Item wizardBootsHealingFire = new ItemWizardArmour(Wizardry.SILK, 1, 3, EnumElement.HEALING).setTextureName("wizardry:wizard_boots_fire");
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		List<Item> orderedItemList = Arrays.asList(
				...
				wizardHatFireIce, wizardRobeFireIce, wizardLeggingsFireIce, wizardBootsFireIce,
				wizardHatFireLightning, wizardRobeFireLightning, wizardLeggingsFireLightning, wizardBootsFireLightning,
				wizardHatFireNecromancy, wizardRobeFireNecromancy, wizardLeggingsFireNecromancy, wizardBootsFireNecromancy,
				wizardHatFireEarth, wizardRobeFireEarth, wizardLeggingsFireEarth, wizardBootsFireEarth,
				wizardHatFireSorcery, wizardRobeFireSorcery, wizardLeggingsFireSorcery, wizardBootsFireSorcery,
				wizardHatFireHealing, wizardRobeFireHealing, wizardLeggingsFireHealing, wizardBootsFireHealing,

				wizardHatIce, wizardRobeIce, wizardLeggingsIce, wizardBootsIce,
				wizardHatIceFire, wizardRobeIceFire, wizardLeggingsIceFire, wizardBootsIceFire,
				wizardHatIceLightning, wizardRobeIceLightning, wizardLeggingsIceLightning, wizardBootsIceLightning,
				wizardHatIceNecromancy, wizardRobeIceNecromancy, wizardLeggingsIceNecromancy, wizardBootsIceNecromancy,
				wizardHatIceEarth, wizardRobeIceEarth, wizardLeggingsIceEarth, wizardBootsIceEarth,
				wizardHatIceSorcery, wizardRobeIceSorcery, wizardLeggingsIceSorcery, wizardBootsIceSorcery,
				wizardHatIceHealing, wizardRobeIceHealing, wizardLeggingsIceHealing, wizardBootsIceHealing,
				
				wizardHatLightning, wizardRobeLightning, wizardLeggingsLightning, wizardBootsLightning,
				wizardHatLightningFire, wizardRobeLightningFire, wizardLeggingsLightningFire, wizardBootsLightningFire,
				wizardHatLightningIce, wizardRobeLightningIce, wizardLeggingsLightningIce, wizardBootsLightningIce,
				wizardHatLightningNecromancy, wizardRobeLightningNecromancy, wizardLeggingsLightningNecromancy, wizardBootsLightningNecromancy,
				wizardHatLightningEarth, wizardRobeLightningEarth, wizardLeggingsLightningEarth, wizardBootsLightningEarth,
				wizardHatLightningSorcery, wizardRobeLightningSorcery, wizardLeggingsLightningSorcery, wizardBootsLightningSorcery,
				wizardHatLightningHealing, wizardRobeLightningHealing, wizardLeggingsLightningHealing, wizardBootsLightningHealing,
				
				wizardHatNecromancy, wizardRobeNecromancy, wizardLeggingsNecromancy, wizardBootsNecromancy,
				wizardHatNecromancyFire, wizardRobeNecromancyFire, wizardLeggingsNecromancyFire, wizardBootsNecromancyFire,
				wizardHatNecromancyIce, wizardRobeNecromancyIce, wizardLeggingsNecromancyIce, wizardBootsNecromancyIce,
				wizardHatNecromancyLightning, wizardRobeNecromancyLightning, wizardLeggingsNecromancyLightning, wizardBootsNecromancyLightning,
				wizardHatNecromancyEarth, wizardRobeNecromancyEarth, wizardLeggingsNecromancyEarth, wizardBootsNecromancyEarth,
				wizardHatNecromancySorcery, wizardRobeNecromancySorcery, wizardLeggingsNecromancySorcery, wizardBootsNecromancySorcery,
				wizardHatNecromancyHealing, wizardRobeNecromancyHealing, wizardLeggingsNecromancyHealing, wizardBootsNecromancyHealing,
				
				wizardHatEarth, wizardRobeEarth, wizardLeggingsEarth, wizardBootsEarth,
				wizardHatEarthFire, wizardRobeEarthFire, wizardLeggingsEarthFire, wizardBootsEarthFire,
				wizardHatEarthIce, wizardRobeEarthIce, wizardLeggingsEarthIce, wizardBootsEarthIce,
				wizardHatEarthLightning, wizardRobeEarthLightning, wizardLeggingsEarthLightning, wizardBootsEarthLightning,
				wizardHatEarthNecromancy, wizardRobeEarthNecromancy, wizardLeggingsEarthNecromancy, wizardBootsEarthNecromancy,
				wizardHatEarthSorcery, wizardRobeEarthSorcery, wizardLeggingsEarthSorcery, wizardBootsEarthSorcery,
				wizardHatEarthHealing, wizardRobeEarthHealing, wizardLeggingsEarthHealing, wizardBootsEarthHealing,
				
				wizardHatSorcery, wizardRobeSorcery, wizardLeggingsSorcery, wizardBootsSorcery,
				wizardHatSorceryFire, wizardRobeSorceryFire, wizardLeggingsSorceryFire, wizardBootsSorceryFire,
				wizardHatSorceryIce, wizardRobeSorceryIce, wizardLeggingsSorceryIce, wizardBootsSorceryIce,
				wizardHatSorceryLightning, wizardRobeSorceryLightning, wizardLeggingsSorceryLightning, wizardBootsSorceryLightning,
				wizardHatSorceryNecromancy, wizardRobeSorceryNecromancy, wizardLeggingsSorceryNecromancy, wizardBootsSorceryNecromancy,
				wizardHatSorceryEarth, wizardRobeSorceryEarth, wizardLeggingsSorceryEarth, wizardBootsSorceryEarth,
				wizardHatSorceryHealing, wizardRobeSorceryHealing, wizardLeggingsSorceryHealing, wizardBootsSorceryHealing,
				
				wizardHatHealing, wizardRobeHealing, wizardLeggingsHealing, wizardBootsHealing,
				wizardHatHealingFire, wizardRobeHealingFire, wizardLeggingsHealingFire, wizardBootsHealingFire,
				wizardHatHealingIce, wizardRobeHealingIce, wizardLeggingsHealingIce, wizardBootsHealingIce,
				wizardHatHealingLightning, wizardRobeHealingLightning, wizardLeggingsHealingLightning, wizardBootsHealingLightning,
				wizardHatHealingNecromancy, wizardRobeHealingNecromancy, wizardLeggingsHealingNecromancy, wizardBootsHealingNecromancy,
				wizardHatHealingEarth, wizardRobeHealingEarth, wizardLeggingsHealingEarth, wizardBootsHealingEarth,
				wizardHatHealingSorcery, wizardRobeHealingSorcery, wizardLeggingsHealingSorcery, wizardBootsHealingSorcery
				);
